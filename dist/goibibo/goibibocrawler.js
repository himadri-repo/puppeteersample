          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 10:
                ...
                url = "".concat(GOIBIBO_URL, "app_id=").concat(app_id, "&app_key=").concat(app_key, "&format=json&source=").concat(source, "&destination=").concat(destination, "&dateofdeparture=").concat(date, "&seatingclass=E&adult=1&children=1&infant=1&counter=100");
