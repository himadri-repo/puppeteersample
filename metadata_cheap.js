            ...
            actions: [
                {
                    ...
                    userinputs: [
                        ...
                        },
                        {
                            id: 3,
                            controlid: '',
                            selector: '.form-horizontal > button[name="login"]',
                            checkcontent: '',
                            type: 'button',
                            value: '',
                            action: 'click',
                            haspostback: true,
                            checkselector: '#lookdata_all'
                        }
                    ]
                }
            ]
            ...
            actions: [
                {
                    ...
                    type: 'code',
                    repeat: true,
                    repeatsourceselector: '#Select_Sector', /*#ctl00_mainbody_Panel1 > div > .ChngColor > a > span*/
                            ...
                            tasks: [
                                {
                                    ...
                                    plugins: [
                                        {
                                            getValue: function(val, idx) {
                                                return val;
                                            },
                                            perform: function(val, idx) {
                                                
                                            }
                                        }
                                    ],
                                    next_task: function(val, idx) {
                                        return 2;
                                    }
                                },
                                {
